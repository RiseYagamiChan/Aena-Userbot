...
STRINGS = {
    1: """ **Terima Kasih Telah Deploy Wynne-Userbot!**

Beberapa Bantuan Untuk Kamu Pelajari.""",
    2: """🎉** Tentang Wynne-Userbot**

 Wynne-Userbot adalah repo userbot yanh dibuat untuk kekasih saya, userbot ini memiliki beberapa fitur kamu bisa melihat nya dihalaman 4.

❣ Dibuat oleh **@WynnenSupport**""",
    3: """
